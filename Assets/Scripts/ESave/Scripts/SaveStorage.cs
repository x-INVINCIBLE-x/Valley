...
namespace Esper.ESave
{
    ...
    public class SaveStorage : MonoBehaviour
    {
        ...
        /// <summary>
        /// Deletes all saves that are added to the save storage. Saves not added are untouched. Use with caution.
        /// </summary>
        public void DeleteAllSaves()
        {
            ...
            var saves = new Dictionary<string, SaveFile>(this.saves);
